...
Security researcher and open-source developer building tools for ethical hacking, penetration testing, and cybersecurity defense.
...
| Project | Description |
|---------|-------------|
| [NullSec Linux](https://github.com/bad-antics/nullsec-linux) | Security-focused Linux distribution with 90+ tools |
| [NullKia](https://github.com/bad-antics/nullkia) | Mobile security framework for all manufacturers |
| [NullSec Tools](https://github.com/bad-antics/nullsec-tools) | Multi-language security toolkit |
| [NullSec Themes](https://github.com/bad-antics/nullsec-themes) | Dark hacker themes for Linux |
| [NullSec Configs](https://github.com/bad-antics/nullsec-configs) | Optimized dotfiles |
...
| [nullsec-cryptocheck](https://github.com/bad-antics/nullsec-cryptocheck) | Ada/SPARK | Crypto implementation verifier |
| [nullsec-dlangaudit](https://github.com/bad-antics/nullsec-dlangaudit) | D | Security audit engine |
